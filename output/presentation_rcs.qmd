...
<img src="images/panel.png"  height="100%" width="100%">
::: 
...
- Capture potential impact of unexpected events

<img src="images/rcs.png"  height="100%" width="100%">
::: 
::::
...
- **Quasi-experiment**: Effects of **naturally occuring** events that cannot be manipulated through controlled experiments 
...
- **Steps** (Kenski et al., 2010):
  ...
  2. Total sample is divided into multiple **replicates** (smaller random samples)
  3. Replicates are assigned to be interviewed at **different intervals of times**
  4. All replicates are treated in the same way (**protocol**)
...
- **Exploratory**: 
  - Determine the possible effects of the occurrence of different events (such as police violence, corruption scandals or reforms) on perceptions of legitimacy, procedural justice and fear of the police in Chile.
...
<br>
<center>
<img src="images/nested1.png" height="35%" width="35%">
</center>
...
<br>
<center>
<img src="images/nested3.png" height="35%" width="35%">
</center>
...
<br>
<center>
<img src="images/decisions.png" height="70%" width="70%">
</center>
...
<br>
<center>
<img src="images/power.png" height="70%" width="70%">
</center>
